...
use corvus_core::{Counters, FingerprintEvent, StreamEvent};
use corvus_intel::{Alert, MatchReport, Verdict};
...
mod tests {
    ...
    use corvus_core::{Counters, FingerprintEvent, Ja3, Ja4Family, StreamEvent};
    use corvus_intel::{Alert, AlertSeverity, FpKind, IntelHit, MatchReport, MatchStrength, Rule};
    ...
    fn folds_intel_and_alerts_into_worst_verdict() {
        ...
        let report = MatchReport::from_hits(
            ...
            vec![IntelHit {
                ...
                category: corvus_intel::Category::Malware,
