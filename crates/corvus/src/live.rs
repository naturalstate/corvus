...
use corvus_core::{PacketSource, RawFrame, SourceError};
...
/// exactly like [`corvus_core::PcapFileSource`] does.
...
mod tests {
    ...
    use corvus_core::{PacketSource, Pipeline, PipelineConfig, SourceError};
    ...
    #[test]
    #[ignore = "needs CAP_NET_RAW or root: sudo -E cargo test -p corvus -- --ignored"]
